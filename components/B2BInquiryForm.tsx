...
export default function B2BInquiryForm() {
    ...
    return (
        <section id="enquiry" className="py-20 bg-white text-black px-6">
            <div className="flex flex-row w-full items-center">
                <div className="flex-1 border-t border-gray-300 mr-3"></div>
                <h2 className="text-4xl text-center font-semibold mb-2">
                    For B2B & serious buyers only
                </h2>
                <div className="flex-1 border-t border-gray-300 ml-3"></div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-6xl mx-auto mt-10">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="mr-2 w-4 h-4 rounded bg-white border-gray-700"
                                    />
                                    <span>GIA</span>
                                </label>
                                <label className="flex items-center">
                            ...
                            <div className="space-y-2">
                                ...
                                <label className="flex items-center">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="mr-2 w-4 h-4 rounded bg-white0 border-gray-700"
                                    />
                ...
                <div className="mt-8 text-center">
                    ...
                    <button
                        type="submit"
                        className="w-full max-w-md mx-auto bg-green-900 text-white py-4 rounded font-medium hover:bg-green-800 transition text-lg cursor-pointer"
                    >
